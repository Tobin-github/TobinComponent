package com.tobin.webview.remotewebview.webviewclient;
...
public class CustomWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        Timber.tag(TAG).e("shouldOverrideUrlLoading url: %s", url);
    ...
    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
        Timber.tag(TAG).e("shouldOverrideUrlLoading url: %s", request.getUrl());
        // 当前链接的重定向
        if (!mWebViewTouch.isTouchByUser()) {
    ...
    public void onPageFinished(WebView view, String url) {
        Timber.tag(TAG).e("onPageFinished url:%s", url);
        if (!TextUtils.isEmpty(url) && url.startsWith(BaseWebView.CONTENT_SCHEME)) {
            isReady = true;
        }
        Timber.tag(TAG).e("onPageFinished isError:%s", isError);
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        Timber.tag(TAG).e("onPageStarted url: %s", url);
    ...
    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
        ...
        Timber.tag(TAG).e("webview error " + errorCode + " + " + description);
        isError = true;
        if (webViewCallBack != null) {
