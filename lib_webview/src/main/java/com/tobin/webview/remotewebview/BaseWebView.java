...
import com.tobin.webview.remotewebview.javascriptinterface.WebViewJavascriptInterface;
import com.tobin.webview.remotewebview.settings.WebviewDefaultSetting;
import com.tobin.webview.remotewebview.webviewclient.CustomWebViewClient;
...
public class BaseWebView extends WebView implements CustomWebViewClient.WebviewTouch {
        ...
        if (remoteInterface == null) {
            ...
            remoteInterface.setJavascriptCommand((Context context, String cmd, String params) -> {
                if (webViewCallBack != null) {
                    Timber.tag("BaseWebView").i("webViewCallBack.exec");
    ...
    public void loadUrl(String url) {
        ...
        Timber.tag(TAG).e("DWebView load url: %s", url);
    ...
    public void handleCallback(String response) {
        if (!TextUtils.isEmpty(response)) {
            Timber.tag("BaseWebView").w("handleCallback response: %s", response);
    ...
    public void dispatchEvent(String name) {
        ...
        param.put("name", name);
        Timber.tag("BaseWebView").w("dispatchEvent param: %s", param.toString());
