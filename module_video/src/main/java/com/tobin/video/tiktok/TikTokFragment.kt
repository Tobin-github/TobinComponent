...
import com.tobin.video.databinding.VideoTiktokFragmentBinding
...
class TikTokFragment : BaseFragment() {
    ...
    private lateinit var binding: VideoTiktokFragmentBinding
    ...
    private fun getData() {
        setData()
        viewPagerAdapter = ViewPagerAdapter(mActivity, mList)
